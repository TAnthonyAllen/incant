...
GroupRules 	*ruler = GroupControl::groupController->groupRules;
	...
	*************************************************************************/
	...
	strap->setParseAction(::aCTionCodE);
	...
	::modify(item,"^");
	item->embedRule(ruler->properties->getMember("delimiter"));
	item = item->getGroup();
	::modify(item,"}^");
	...
	*************************************************************************/
	...
	strap->setParseAction(::processFlags);
