...
GroupItem 	*source = 0;
	...
	// ⚠ A REFUSED STAR YIELDS NULL and unWrap has no null guard -- refuse SILENTLY
	// here (the star already spoke) but POISON THE CURSOR, or ++ runs away
	// ruleActions.aCTionIterate.nullAfterStar
	if ( !source )
	{
